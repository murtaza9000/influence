  ...
  <body class="hold-transition register-page register-background">
    <div class="register-box">
      ...
      <div class="register-box-body">
        <p class="login-box-msg">Thank for signing up - We have sent you a confirmation link on the email you used to register. <br />
          Please check that email inbox for the confirmation link, be patient as it may take few minutes or may land in your spam/junk filter</p>
      </div>
    </div><!-- /.register-box -->
