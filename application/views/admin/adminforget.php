    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <?php echo form_open('adminlogin/resetpassword'); ?>
          ...
          <div class="row">
            <div class="col-xs-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat">Click here</button>
            </div><!-- /.col -->
          </div>
           <a href="<?=base_url()?>registeradmin" class="text-center">Register a new membership</a></br>
           <a href="<?=base_url()?>adminlogin" class="text-center">Login Again</a>
          </div>
        </form>
