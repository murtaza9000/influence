...
"></span>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown notifications-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span
                                class="label label-warning"><?= is_null($notification_links) ? '0' : $notification_links ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <li class="header">You have <?= is_null($notification_links) ? '0' : $notification_links ?>
                                notifications
                            </li>
                            <li>
                                    ...
                                    <ul class="menu">
                                        <li><!-- start notification -->
                                            ...
                                            <a href="<?= base_url(); ?>admin/inf">
                                                <i class="fa fa-users text-aqua"></i><?= $notification_links ?> more
                                                Users are added
                                            </a>
                                        </li><!-- end notification -->
                                    </ul>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    ...
                                    <a href="<?= base_url(); ?>registeradmin/out" class="btn btn-default btn-flat">Sign
                                        out</a>
                                </div>
                            </li>
                        </ul>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <form action="<?php echo (basename(current_url()) == 'influencer') ? 'index' : basename(current_url()); ?>"
                  method="post" class="sidebar-form">
                <div class="input-group">
                    <input type="text" name="search" class="form-control" placeholder="Search...">
                    <input type="hidden" name="page" value="<?= basename(current_url()); ?>" class="form-control"
                           placeholder="Search...">
            ...
            <ul class="sidebar-menu">
                ...
                <li <?php echo ($active == 'home') ? 'class="active"' : ''; ?>><a
                        href="<?php echo base_url(); ?>admin/"><i class="fa fa-link"></i>
                        <span>Home</span></a></li>
                <li <?php echo ($active == 'inf') ? 'class="active"' : ''; ?>><a
                        href="<?php echo base_url(); ?>admin/inf"><i class="fa fa-link"></i>
                        <span>List of Influencer</span></a></li>
                ...
                <li <?php echo ($active == 'viral') ? 'class="active"' : ''; ?>><a
                        href="<?php echo base_url(); ?>admin/viral"><i class="fa fa-link"></i>
                        <span>List of Viral Links</span></a></li>
                <li <?php echo ($active == 'pub' || $active == 'dom') ? 'class="treeview active"' : 'class="treeview"'; ?>>
                    <a href="#"><i class="fa fa-link"></i> <span>Publisher</span> <i
                            class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">
                        <li <?php echo ($active == 'pub') ? 'class="active"' : ''; ?>><a
                                href="<?php echo base_url(); ?>admin/pub">List of Publisher</a></li>
                        <li <?php echo ($active == 'dom') ? 'class="active"' : ''; ?>><a
                                href="<?php echo base_url(); ?>admin/dom/all">List of Domains</a></li>

                    </ul>
                <li <?php echo ($active == 'checkout') ? 'class="active"' : ''; ?>><a
                        href="<?php echo base_url(); ?>admin/checkout"><i class="fa fa-link"></i>
                        <span>Payment Log</span></a></li>
                <li <?php echo ($active == 'earning_history') ? 'class="active"' : ''; ?>><a
                        href="<?php echo base_url(); ?>admin/earning_history"><i class="fa fa-link"></i> <span>Earning history</span></a>
                </li>
                </li>
            </ul><!-- /.sidebar-menu -->
        </section>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                ...
                                <span
                                    class="info-box-number"><?= is_null($notification_links) ? '0' : $notification_links ?></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    </div>
