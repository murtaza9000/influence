...
<div class="wrapper">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    ...
                                    <a href="<?= base_url(); ?>register/logout" class="btn btn-default btn-flat">Sign
                                        out</a>
                                </div>
                            </li>
                        </ul>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <form
                action="<?php echo (basename(current_url()) == 'influencer') ? 'influencer/index' : basename(current_url()); ?>"
            ...
            <ul class="sidebar-menu">
                ...
                <li <?php echo ($active == 'inf') ? 'class="active"' : ''; ?>><a
                        href="<?php echo base_url(); ?>influencer/inf"><i class="fa fa-link"></i>Latest Links</a></li>
                <li <?php echo ($active == 'viral') ? 'class="active"' : ''; ?>><a
                        href="<?php echo base_url(); ?>influencer/viral"><i class="fa fa-link"></i>
                        <span>Viral Links</span></a></li>


                <li <?php echo ($active == 'contact') ? 'class="active"' : ''; ?>><a
                        href="<?php echo base_url(); ?>influencer/contact"><i class="fa fa-link"></i>
                        <span>Contact Us! </span></a></li>
                <li <?php echo ($active == 'payment_history') ? 'class="active"' : ''; ?>><a
                        href="<?php echo base_url(); ?>influencer/payment_history"><i class="fa fa-link"></i> <span>Earnings </span></a>
                </li>
                <li <?php echo ($active == 'checkout') ? 'class="active"' : ''; ?>><a
                        href="<?php echo base_url(); ?>influencer/checkout"><i class="fa fa-link"></i> <span>Payment History </span></a>
                </li>
